...
class Dataset_test(torch.utils.data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        graph, adj_matrix, decoder_input, nodes, img_centre = self.load_images_and_process(index)
        ...
        train_data = torch.from_numpy(graph), \
                     ...
                     torch.from_numpy(decoder_input),\
                     torch.from_numpy(self.track['output'][index][0]),\
                     self.track['ped_ids'][index][0],\
                     self.track['images'][index][-1],\
                     nodes,\
                     img_centre
    ...
    def load_images_and_process(self,
        ...
        return graph, adj_matrix, decoder_input, node_features, img_centre_seq
